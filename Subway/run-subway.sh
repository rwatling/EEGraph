...
do
    ...
    do
        ...
        ./bfs-async --input "${j}" --energy true --efile "./data/subway-energy/bfs/async/${j}-${file}-readings" --estats "./data/subway-energy/bfs/async/${j}-${file}-stats" > "./data/subway-energy/bfs/async/${i}-${file}"
        ./bfs-sync --input "${j}" --energy true --efile "./data/subway-energy/bfs/sync/${j}-${file}-readings" --estats "./data/subway-energy/bfs/sync/${j}-${file}-stats" > "./data/subway-energy/bfs/sync/${i}-${file}"
        

        ./cc-async --input "${j}" > "./data/subway/cc/async/${i}-${file}"
        ./cc-sync --input "${j}" > "./data/subway/cc/sync/${i}-${file}"
        ./cc-async --input "${j}" --energy true --efile "./data/subway-energy/cc/async/${j}-${file}-readings" --estats "./data/subway-energy/cc/async/${j}-${file}-stats" > "./data/subway-energy/cc/async/${i}-${file}"
        ./cc-sync --input "${j}" --energy true --efile "./data/subway-energy/cc/sync/${j}-${file}-readings" --estats "./data/subway-energy/cc/sync/${j}-${file}-stats" > "./data/subway-energy/cc/sync/${i}-${file}"
        

        ./pr-async --input "${j}" > "./data/subway/pr/async/${i}-${file}"
        ./pr-sync --input "${j}" > "./data/subway/pr/sync/${i}-${file}"
        ./pr-async --input "${j}" --energy true --efile "./data/subway-energy/pr/async/${j}-${file}-readings" --estats "./data/subway-energy/pr/async/${j}-${file}-stats" > "./data/subway-energy/pr/async/${i}-${file}"
        ./pr-sync --input "${j}" --energy true --efile "./data/subway-energy/pr/sync/${j}-${file}-readings" --estats "./data/subway-energy/pr/sync/${j}-${file}-stats" > "./data/subway-energy/pr/sync/${i}-${file}"
        

        ./sssp-async --input "${j}" > "./data/subway/sssp/async/${i}-${file}"
        ./sssp-sync --input "${j}" > "./data/subway/sssp/sync/${i}-${file}"
        ./sssp-async --input "${j}" --energy true --efile "./data/subway-energy/sssp/async/${j}-${file}-readings" --estats "./data/subway-energy/sssp/async/${j}-${file}-stats" > "./data/subway-energy/sssp/async/${i}-${file}"
        ./sssp-sync --input "${j}" --energy true --efile "./data/subway-energy/sssp/sync/${j}-${file}-readings" --estats "./data/subway-energy/sssp/sync/${j}-${file}-stats" > "./data/subway-energy/sssp/sync/${i}-${file}"
        ...
        ./sswp-sync --input "${j}" --energy true --efile "./data/subway-energy/sswp/sync/${j}-${file}-readings" --estats "./data/subway-energy/sswp/sync/${j}-${file}-stats" > "./data/subway-energy/sswp/sync/${i}-${file}"
