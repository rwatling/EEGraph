...
Result eegraph_cc_um(ArgumentParser &arguments, Graph &graph);

Result eegraph_pr(ArgumentParser &arguments, Graph &graph);

Result eegraph_pr_um(ArgumentParser &arguments, Graph &graph);

Result eegraph_sswp(ArgumentParser &arguments, Graph &graph);

Result eegraph_sswp_um(ArgumentParser &arguments, Graph &graph);

Result eegraph_sssp(ArgumentParser &arguments, Graph &graph);

Result eegraph_sssp_um(ArgumentParser &arguments, Graph &graph);