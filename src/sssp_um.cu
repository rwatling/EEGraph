...
__global__ void sssp_um::async_push_td(  unsigned int numParts, 
...
__global__ void sssp_um::sync_push_td(  unsigned int numParts, 
                                     unsigned int *nodePointer,
									 UMPartPointer *partNodePointer, 
                                     unsigned int *edgeList,
                                     unsigned int* dist,
...
__global__ void sssp_um::sync_push_dd(  unsigned int numParts, 
                                     unsigned int *nodePointer,
									 UMPartPointer *partNodePointer, 
                                     unsigned int *edgeList,
                                     unsigned int* dist,
...
__global__ void sssp_um::async_push_dd(  unsigned int numParts, 
                                     unsigned int *nodePointer,
									 UMPartPointer *partNodePointer, 
                                     unsigned int *edgeList,
                                     unsigned int* dist,
...
void sssp_um::seq_cpu(  UMEdge* edges, 
                     uint* weights, 
                     uint num_edges, 
                     int source, 
                     unsigned int* dist  )
